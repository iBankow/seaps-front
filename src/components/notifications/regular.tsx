    ...
    >
      <div>
        <div className="mb-6">
          ...
          <p className="mt-2">Sede EMPAER em Santo Antônio do Leverger/MT</p>
        </div>

        <section className="mb-6 space-y-2">
          <p>À Senhora</p>
          <strong>Flávia de Souza Almeida</strong>
          <p>Diretora de Administração Sistêmica</p>
          <p>
        ...
        <footer className="text-center text-xs text-gray-600">
          <p>Relatório de vistoria anexo. • Endereço do órgão • Contato</p>
        </footer>
      </div>
    </div>
  );
